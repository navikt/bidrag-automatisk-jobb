...
class ReskontroServiceTest {
    ...
    private fun opprettTransaksjon(datoperiode: Datoperiode?, beløp: BigDecimal?, transaksjonskode: String): TransaksjonDto = TransaksjonDto(
    ...
    fun `skal returnere true hvis en av flere perioder matcher`() {
        ...
        val resultat = reskontroService.finnesForskuddForSakPeriode(
            Saksnummer("123"),
