...
@Component
class BrevBpUtlandIndeksreguleringBidragBatch(
    @param:Qualifier("asyncJobLauncher") private val jobOperator: JobOperator,
    private val brevBpUtlandIndeksreguleringBidragJob: Job,
) {
    fun start(år: Int = Year.now().value) {
        try {
            jobOperator.start(
                brevBpUtlandIndeksreguleringBidragJob,
            ...
            LOGGER.warn { "Batch brevBpUtlandIndeksreguleringBidrag kjører allerede. Ignorerer ny forespørsel." }
        }
    }
}
