 ...
 *
 * Bakgrunn:
 * En sak kan ha flere barn som alle mottar forskudd. [OpprettIndeksreguleringForskuddBatchProcessor]
 ...
 *
 * Utvalg:
 * Det hentes barn som har et løpende forskudd, på samme måte som
 * [BarnRepository.findBarnSomSkalRevurdereForskudd]. Dersom det er angitt en liste med saksnummer
 ...
 */
class OpprettIndeksreguleringForskuddBatchReader(
    ...
    private fun byggDelegate(): RepositoryItemReader<Barn> {
        val builder =
            RepositoryItemReaderBuilder<Barn>()
                .name("opprettIndeksreguleringForskuddBatchReader")
        ...
        return if (saksnummer.isEmpty()) {
            ...
            builder
                .methodName("finnBarnMedLøpendeForskuddForSaksnummer")
                .arguments(listOf(forskuddFremTilDato, saksnummer))
                .build()
        }
    }
